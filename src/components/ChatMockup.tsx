    ...
    >
      ...
      <div className="rounded-[2rem] bg-foreground/90 p-2 shadow-2xl shadow-primary/20">
        ...
        <div className="rounded-t-[1.5rem] bg-primary px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <p className="text-primary-foreground font-display font-bold text-sm">SchoolRemind</p>
            <p className="text-primary-foreground/70 text-xs">online</p>
          </div>
        </div>

        {/* Chat area */}
        <div className="bg-whatsapp-light p-3 space-y-2 min-h-[380px]" style={{ backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%2322c55e' fill-opacity='0.05'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")" }}>
          {messages.map((msg, i) => (
            <motion.div
              key={i}
